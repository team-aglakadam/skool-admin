...
export function StudentsProvider({ children }: { children: ReactNode }) {
  ...
  const addStudent = async (studentData: CreateStudentData): Promise<{ success: boolean; error?: string }> => {
    try {
  ...
  const getStudentsBySection = (classId: string, sectionId: string): Student[] => {
